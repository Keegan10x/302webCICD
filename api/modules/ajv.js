  ...
  }(
    {
        ...
        function c(e, r, t) {
          ...
          return n && (s = n.schema, r = n.root, i = n.baseId),
            s instanceof l
              ...
              : void 0 !== s && (o = d(s, this._opts.inlineRefs)
                ? s
          ...
          c.ids = function (e) {
            ...
            return a(e, { allKeys: !0 }, function (e, r, t, a, s, o, i) {
              if ("" !== r) {
                ...
                if (
                  void 0 !== i && (c += "/" + ("number" == typeof i
                    ? i
                    : y.escapeFragment(i))), "string" == typeof n
                ) {
          ...
          checkDataTypes: function (e, r) {
            switch (e.length) {
              ...
              default:
                var t = "", a = n(e);
                for (
                  var s in a.array && a.object && (t = a.null
                    ? "("
                    : "(!" + r + " || ",
                    t += "typeof " + r + ' !== "object")',
                    delete a.null,
      ...
      16: [function (e, r, t) {
        ...
        r.exports = function (e, r) {
          ...
          var d = r, f = f || [];
          f.push(
            a += " Object.keys(" + u + ").length " + ("maxProperties" == r
              ? ">"
              : "<") + " " + t + ") { ",
          ),
            a = "",
      ...
      25: [function (e, r, t) {
        ...
        r.exports = function (e, r, t) {
          ...
          if (d) {
            ...
            var v,
              y =
                (v = "object" == typeof m && !(m instanceof RegExp) &&
      ...
      28: [function (e, r, t) {
        ...
        r.exports = function (e, r) {
          ...
          if (t += "var " + h + " = errors;var " + u + ";", Array.isArray(o)) {
            ...
            if (
              "object" == typeof P && (e.opts.strictKeywords
                ? "object" == typeof P && 0 < Object.keys(P).length
                : e.util.schemaHasRules(P, e.RULES.all))
            ) {
              d.schema = P,
      ...
      35: [function (e, r, t) {
        ...
        r.exports = function (e, r) {
          ...
          if (a) {
            ...
            (v = v || []).push(s),
              s = "",
              s += e.opts.passContext ? " " + a + ".call(this, "
              : " " + a + "( ",
              s += " " + c + ", (dataPath || '')",
              '""' != e.errorPath && (s += " + " + e.errorPath);
      ...
      38: [function (e, r, t) {
        ...
        r.exports = function (a, e) {
          ...
          if (
            w && a.opts.nullable && !0 === a.schema.nullable && (b
          ...
          if (
            ...
            if (S || b || !0 === _ || _ && !G(_)) {
              ...
              if (
                ...
                r = Z.pop(),
                  r += !a.compositeRule && f
                    ? a.async ? " throw new ValidationError([" + v + "]); "
                    : " validate.errors = [" + v + "]; return false; "
                    : " var err = " + v +
                      ";  if (vErrors === null) vErrors = [err]; else vErrors.push(err); errors++; ",
                  r += " } else {  ";
        ...
        a = this,
          function (e) {
            ...
            function q(e, r, t) {
              var a = 0;
              for (
                e = t ? C(e / 700) : e >> 1, e += C(e / r); 455 < e; a += 36
              ) {
                e = C(e / 35);
              }
                  ...
                  encode: function (e) {
                    return String.fromCodePoint.apply(
                      ...
                      function (e) {
                        if (Array.isArray(e)) {
                          for (
                            var r = 0, t = Array(e.length); r < e.length; r++
                          ) {
                            t[r] = e[r];
                          }
                          return t;
            ...
            function _(e) {
              ...
              if (s) {
                E
                  ...
                  t.reference =
                    void 0 !== t.scheme || void 0 !== t.userinfo ||
                      void 0 !== t.host || void 0 !== t.port || t.path ||
                      void 0 !== t.query
                      ? void 0 === t.scheme ? "relative"
                      : void 0 === t.fragment ? "absolute" : "uri"
                      : "same-document",
            ...
            function j(r) {
              ...
              if (
                ...
                try {
                  r.host = t.iri ? v.toUnicode(r.host)
                  : v.toASCII(r.host.replace(e.PCT_ENCODED, f).toLowerCase());
                } catch (e) {
                  r.error = r.error ||
                    "Host's domain name can not be converted to " + (t.iri
                        ? "Unicode"
                        : "ASCII") +
                      " via punycode: " + e;
                }
        ...
        function y(e) {
          ...
          e = this._opts = c.copy(e) || {},
            ...
            e.formats && function (e) {
              for (var r in e._opts.formats) e.addFormat(r, e._opts.formats[r]);
            }(this),
